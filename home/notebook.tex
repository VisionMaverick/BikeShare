...
\textbf{Answer}: 1. How does ridership differ by month or season?
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k}{def} \PY{n+nf}{duration\PYZus{}in\PYZus{}mins}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{n}{duration} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}
            \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Washington}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                \PY{n}{duration} \PY{o}{=} \PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Duration (ms)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{l+m+mi}{1000}\PY{o}{*}\PY{l+m+mi}{60}\PY{p}{)}\PY{p}{)} \PY{o}{\PYZpc{}} \PY{l+m+mi}{60}
            \PY{k}{else}\PY{p}{:}
                \PY{n}{duration} \PY{o}{=} \PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{tripduration}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{60}\PY{p}{)} \PY{o}{\PYZpc{}} \PY{l+m+mi}{60}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k+kn}{import} \PY{n+nn}{calendar}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{n}{month} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}
            \PY{n}{hour} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}
            \PY{n}{day\PYZus{}of\PYZus{}week} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}
            \PY{n}{start\PYZus{}time} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdq{}}
            \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NYC}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{start\PYZus{}time} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{starttime}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{S}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            ...
            \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Washington}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{start\PYZus{}time} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{datum}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Start date}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y }\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{H:}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{M}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         
            \PY{n}{month} \PY{o}{=} \PY{n}{start\PYZus{}time}\PY{o}{.}\PY{n}{month}
            \PY{n}{hour} \PY{o}{=} \PY{n}{start\PYZus{}time}\PY{o}{.}\PY{n}{hour}
            \PY{n}{day\PYZus{}of\PYZus{}week} \PY{o}{=} \PY{n}{calendar}\PY{o}{.}\PY{n}{day\PYZus{}name}\PY{p}{[}\PY{n}{datetime}\PY{o}{.}\PY{n}{weekday}\PY{p}{(}\PY{n}{start\PYZus{}time}\PY{p}{)}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{type\PYZus{}of\PYZus{}user}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{l+s+sd}{    Takes as input a dictionary containing info about a single trip (datum) and}
...
\textbf{Answer}: 1. NYC has highest number of the trips. 2. NYC has
highest number of subscriber 3. Chicago has highest number of customer
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{def} \PY{n+nf}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                ...
                \PY{n}{subscribers\PYZus{}proportion} \PY{o}{=} \PY{p}{(}\PY{n}{n\PYZus{}subscribers} \PY{o}{*} \PY{l+m+mi}{100}\PY{p}{)} \PY{o}{/} \PY{n}{n\PYZus{}total}
                \PY{n}{customers\PYZus{}proportion} \PY{o}{=} \PY{p}{(}\PY{n}{n\PYZus{}customers} \PY{o}{*} \PY{l+m+mi}{100}\PY{p}{)} \PY{o}{/} \PY{n}{n\PYZus{}total}
                
                \PY{c+c1}{\PYZsh{} return tallies as a tuple}
                \PY{k}{return}\PY{p}{(}\PY{n}{n\PYZus{}subscribers}\PY{p}{,} \PY{n}{n\PYZus{}customers}\PY{p}{,} \PY{n}{n\PYZus{}total}\PY{p}{,}\PY{n}{subscribers\PYZus{}proportion}\PY{p}{,}\PY{n}{customers\PYZus{}proportion}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Modify this and the previous cell to answer Question 4a. Remember to run \PYZsh{}\PYZsh{}}
         ...
         \PY{n}{data\PYZus{}files} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                       ...
                       \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{p}{]}
         ...
         \PY{k}{for} \PY{n}{data\PYZus{}file} \PY{o+ow}{in} \PY{n}{data\PYZus{}files}\PY{p}{:}
             ...
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)} 
\end{Verbatim}
...
\textbf{Answer}: What is the average trip length for each city? NYC =
13.24 Chicago = 14.15 Washington = 14.22

What proportion of rides made in each city are longer than 30 minutes?
NYC = 6.6\% Chicago = 6.9\% Washington = 7.10\%
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4b.                 \PYZsh{}\PYZsh{}}
         ...
         \PY{k}{def} \PY{n+nf}{trip\PYZus{}length}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    This function reads in a file with trip data and reports the number of}
         \PY{l+s+sd}{    trips made by subscribers, customers, and total overall.}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{n}{dur\PYZus{}total} \PY{o}{=} \PY{l+m+mf}{0.0}
                 \PY{n}{log\PYZus{}dur\PYZus{}total} \PY{o}{=} \PY{l+m+mi}{0}
                 
                 \PY{c+c1}{\PYZsh{} tally up ride types}
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                     \PY{n}{n\PYZus{}total} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                     \PY{n}{dur\PYZus{}total} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                     \PY{k}{if} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o}{\PYZgt{}} \PY{l+m+mi}{30}\PY{p}{:}
                         \PY{n}{log\PYZus{}dur\PYZus{}total} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
         
                 
                 \PY{c+c1}{\PYZsh{} compute average trip length of rides}
                 \PY{n}{average\PYZus{}trip\PYZus{}length} \PY{o}{=} \PY{n}{dur\PYZus{}total} \PY{o}{/} \PY{n}{n\PYZus{}total}
                 
                 \PY{n}{longer\PYZus{}rides} \PY{o}{=} \PY{p}{(}\PY{n}{log\PYZus{}dur\PYZus{}total} \PY{o}{*} \PY{l+m+mi}{100}\PY{p}{)} \PY{o}{/} \PY{n}{n\PYZus{}total}        
                 
                 \PY{c+c1}{\PYZsh{} return tallies as a tuple}
                 \PY{k}{return}\PY{p}{(}\PY{n}{average\PYZus{}trip\PYZus{}length}\PY{p}{,} \PY{n}{longer\PYZus{}rides}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{data\PYZus{}files} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                       \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                       \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{p}{]}
         ...
         \PY{k}{for} \PY{n}{data\PYZus{}file} \PY{o+ow}{in} \PY{n}{data\PYZus{}files}\PY{p}{:}
             \PY{n}{city} \PY{o}{=} \PY{n}{data\PYZus{}file}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{city}\PY{p}{)}
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{trip\PYZus{}length}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)} 
\end{Verbatim}
...
\textbf{Answer}: Customers are taking longer rides on average.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4c. If you have    \PYZsh{}\PYZsh{}}
        ...
        \PY{k}{def} \PY{n+nf}{ave\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{l+s+sd}{    This function reads in a file with trip data and reports the number of}
        \PY{l+s+sd}{    trips made by subscribers, customers, and total overall.}
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
               ...
               \PY{c+c1}{\PYZsh{} initialize count variables}
                \PY{n}{n\PYZus{}subscribers} \PY{o}{=} \PY{l+m+mi}{0}
                \PY{n}{n\PYZus{}customers} \PY{o}{=} \PY{l+m+mi}{0}
                \PY{n}{dur\PYZus{}subscribers} \PY{o}{=} \PY{l+m+mf}{0.0}
                \PY{n}{dur\PYZus{}customers} \PY{o}{=} \PY{l+m+mf}{0.0}
                
                \PY{c+c1}{\PYZsh{} tally up ride types}
                \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                    \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                        \PY{n}{n\PYZus{}subscribers} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                        \PY{n}{dur\PYZus{}subscribers} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                    \PY{k}{else}\PY{p}{:}
                        \PY{n}{n\PYZus{}customers} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                        \PY{n}{dur\PYZus{}customers} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                
                \PY{c+c1}{\PYZsh{} compute average trip length of rides}
                \PY{n}{ave\PYZus{}sub\PYZus{}trip\PYZus{}length} \PY{o}{=} \PY{n}{dur\PYZus{}subscribers} \PY{o}{/} \PY{n}{n\PYZus{}subscribers}
                \PY{n}{ave\PYZus{}cust\PYZus{}trip\PYZus{}length} \PY{o}{=} \PY{n}{dur\PYZus{}customers} \PY{o}{/} \PY{n}{n\PYZus{}customers}
                
            
                \PY{c+c1}{\PYZsh{} return tallies as a tuple}
                \PY{k}{return}\PY{p}{(}\PY{n}{ave\PYZus{}sub\PYZus{}trip\PYZus{}length}\PY{p}{,} \PY{n}{ave\PYZus{}cust\PYZus{}trip\PYZus{}length}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{data\PYZus{}files} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                      \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                      \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                      \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./examples/BayArea\PYZhy{}Y3\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
        
        \PY{k}{for} \PY{n}{data\PYZus{}file} \PY{o+ow}{in} \PY{n}{data\PYZus{}files}\PY{p}{:}
            \PY{n}{city} \PY{o}{=} \PY{n}{data\PYZus{}file}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}
            \PY{n+nb}{print}\PY{p}{(}\PY{n}{city}\PY{p}{)}
            \PY{n+nb}{print}\PY{p}{(}\PY{n}{ave\PYZus{}trip\PYZus{}length}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)} 
\end{Verbatim}
...
library and to generate an example plot.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} load library}
...
and Customers for now: just collect all of the trip times and plot them.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to collect all of the trip times as a list \PYZsh{}\PYZsh{}}
        \PY{c+c1}{\PYZsh{}\PYZsh{} and then use pyplot functions to generate a histogram of trip times.     \PYZsh{}\PYZsh{}}
        
        \PY{k}{def} \PY{n+nf}{trip\PYZus{}times}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{l+s+sd}{    This function reads in a file with trip data and reports the number of}
        \PY{l+s+sd}{    trips made by subscribers, customers, and total overall.}
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
               ...
               \PY{c+c1}{\PYZsh{} initialize count variables}
                \PY{n}{total\PYZus{}trip\PYZus{}times} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                \PY{n}{sub\PYZus{}trip\PYZus{}times} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                \PY{n}{cus\PYZus{}trip\PYZus{}times} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                
                \PY{c+c1}{\PYZsh{} iterate all trip data}
                \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                    \PY{c+c1}{\PYZsh{}Add trip duration in a list}
                    \PY{n}{total\PYZus{}trip\PYZus{}times}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}  
                    \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}} \PY{o+ow}{and} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o}{\PYZlt{}} \PY{l+m+mi}{75}\PY{p}{:}
                        \PY{n}{sub\PYZus{}trip\PYZus{}times}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                    \PY{k}{elif} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)} \PY{o}{\PYZlt{}} \PY{l+m+mi}{75}\PY{p}{:}
                        \PY{n}{cus\PYZus{}trip\PYZus{}times}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
            
                \PY{c+c1}{\PYZsh{} return tallies as a tuple}
                \PY{k}{return}\PY{p}{(}\PY{n}{total\PYZus{}trip\PYZus{}times}\PY{p}{,}\PY{n}{sub\PYZus{}trip\PYZus{}times}\PY{p}{,}\PY{n}{cus\PYZus{}trip\PYZus{}times}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{} load library}
        \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
        ...
        \PY{c+c1}{\PYZsh{} example histogram, data taken from NYC  summary file}
        \PY{n}{total\PYZus{}trip\PYZus{}times}\PY{p}{,}\PY{n}{sub\PYZus{}trip\PYZus{}times}\PY{p}{,} \PY{n}{cus\PYZus{}trip\PYZus{}times} \PY{o}{=} \PY{n}{trip\PYZus{}times}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
        \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{total\PYZus{}trip\PYZus{}times}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Trip Durations}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: 1. 5 minutes to 10 minutes is peak for subscriber 2. 20
minutes is is peak for customer

Number of sbsciber count is reducing when moving towards higher trip
duration Number of customer count is volatile
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 5. \PYZsh{}\PYZsh{}}
        ...
        \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{sub\PYZus{}trip\PYZus{}times}\PY{p}{)}
        ...
        \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{cus\PYZus{}trip\PYZus{}times}\PY{p}{)}
...
\textbf{Answer}: Does the ratio of Subscriber trips to Customer trips
change depending on the month or season?

Subscriber snd cudtomers are taking more ride in September

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to continue to explore the dataset. \PYZsh{}\PYZsh{}}
        ...
        \PY{k}{def} \PY{n+nf}{trip\PYZus{}frequency}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{l+s+sd}{    This function reads in a file with trip data and reports the number of}
        \PY{l+s+sd}{    trips made by subscribers, customers, and total overall.}
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
               ...
               \PY{c+c1}{\PYZsh{} initialize dictionry        }
                \PY{n}{sub\PYZus{}trips} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
                \PY{n}{cus\PYZus{}trips} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
                
                \PY{c+c1}{\PYZsh{} iterate all trip data}
                \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                    \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                        \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o+ow}{in} \PY{n}{sub\PYZus{}trips}\PY{p}{:}
                            \PY{n}{sub\PYZus{}trips}\PY{p}{[}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{]} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                        \PY{k}{else}\PY{p}{:}
                            \PY{n}{sub\PYZus{}trips}\PY{p}{[}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{1}                
                    \PY{k}{else}\PY{p}{:}
                        \PY{k}{if} \PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o+ow}{in} \PY{n}{cus\PYZus{}trips}\PY{p}{:}
                            \PY{n}{cus\PYZus{}trips}\PY{p}{[}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{]} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                        \PY{k}{else}\PY{p}{:}
                            \PY{n}{cus\PYZus{}trips}\PY{p}{[}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{]} \PY{o}{=} \PY{l+m+mi}{1}                 
                        
                \PY{n+nb}{print}\PY{p}{(}\PY{n}{sub\PYZus{}trips}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{n}{cus\PYZus{}trips}\PY{p}{)}
                \PY{c+c1}{\PYZsh{} return tallies as a tuple}
                \PY{k}{return}\PY{p}{(}\PY{n}{sub\PYZus{}trips}\PY{p}{,}\PY{n}{cus\PYZus{}trips}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 5. \PYZsh{}\PYZsh{}}
        ...
        \PY{c+c1}{\PYZsh{} example histogram, data taken from NYC  summary file}
        \PY{n}{sub\PYZus{}trips}\PY{p}{,}\PY{n}{cus\PYZus{}trips} \PY{o}{=} \PY{n}{trip\PYZus{}frequency}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
        \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{sub\PYZus{}trips}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Trip Durations for Subscribers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
        
        \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{cus\PYZus{}trips}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Trip Durations for Customers}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: I would like to explore equity market data to know what
are the major factor that have more impacts on equity markets.
